 ...
 *
 * Created by Andrey on 05.07.2021
 */
...
abstract class SearchBgRender(
    ...
    fun getLineTop(layout: Layout, line: Int): Int {
        return layout.getLineTopWithoutPadding(line) // todo without padding
    }

    fun getLineBottom(layout: Layout, line: Int): Int {
        return layout.getLineBottomWithoutPadding(line) // todo without padding
    }
}
