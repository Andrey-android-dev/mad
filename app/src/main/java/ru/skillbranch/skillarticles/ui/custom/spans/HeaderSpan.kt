...
//        drawLine(0f, paint.ascent()+lineBaseline, width + 0f, paint.ascent() + lineBaseline, Paint().apply { color = Color.GRAY })
//        drawLine(0f, paint.descent()+lineBaseline, width + 0f, paint.descent() + lineBaseline, Paint().apply { color = Color.YELLOW })
    }
